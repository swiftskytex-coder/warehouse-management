...
Полная система управления складскими карточками товаров с интеграцией snab-lift.ru.

## ✨ Основные возможности

### 🔍 Поиск товаров
- **Быстрый поиск** — по артикулу, названию, производителю
...
- **Диск**: 1 GB (для базы с 10,000+ товаров)
- **Интернет**: только для импорта товаров
...
# 2. Открываем веб-интерфейс для управления
$ open http://localhost:8080
# Редактируем количество, зоны, печатаем карточки

# 3. Создаем HTML карточки для всех товаров
...
✅ **Без абонентской платы** — все работает локально  
